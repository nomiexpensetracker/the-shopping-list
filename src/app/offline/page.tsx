  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground px-6 text-center">
      ...
      <p className="text-muted text-sm mb-8 max-w-xs">
        No internet connection. Your last synced list data may still be
        available — try going back.
      </p>

      <button
        onClick={() => window.location.reload()}
        className="px-6 py-3 bg-brand text-white rounded-xl font-semibold text-sm active:opacity-80"
      >
        Try again
      </button>
    </div>
